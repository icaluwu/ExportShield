...
export const milestoneEscrowAbi = [
  ...
  ...["fundProject", "acceptProject", "cancelProject", "refundUnacceptedProject"].map(
    (name) => ({
...
export const PROJECT_STATUS = ["Created", "Funded", "Active", "Completed", "Cancelled", "Refunded"] as const;
export const MILESTONE_STATUS = ["Pending", "Submitted", "Paid"] as const;
